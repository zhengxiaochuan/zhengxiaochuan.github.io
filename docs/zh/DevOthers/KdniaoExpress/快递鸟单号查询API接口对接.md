...
>
> 调用快递鸟快递单号查询API接口，就能查询到1600多家以上快递公司单号从收件、运输，到转运中心，派送到签收等各个环节的物流发货状态。快递鸟api接口不区分开发语言，支持Java，C#，PHP，Python，ObjectC等开发语言的程序调用。
...
![img](./assets/ce159e183b2f57e1b1b49614ca1b8d20.png)
...
快递单号查询接口在Web端的应用效果展示如下：

![img](./assets/a33a64bee87e85d30ee87af01dcf53c9.png)

或者在手机端的展示效果如下：

![img](./assets/d2393d03dcfa421aa76f353956b2e87c.png)
...
> **未实名认证、未订购套餐、套餐可用查询量已经用完，都会返回此报文信息**，去实名认证/ 了解套餐详情即可。
